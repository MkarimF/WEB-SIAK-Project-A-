        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?=base_url('prodi/add') ?>" class="btn btn-box-tool"><i class="fa fa-plus"></i></a>Add 
                </div>
            </div>
            ...
            <div class="box-body">
                ...
                ?>
                <table class="table tale-bordered table-striped"id="example1">
                    <thead>
                        <tr>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   Apakah anda yakin ingin menghapus <b><?= $value['proddi']?></b>?
