        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input name="mata_kuliah" class="form-control" placeholder="Mata Kuliah" >
                </div>
                <div class="form-group">
                    <label>SKS</label>
    ...
    <div class="modal fade" id="delete<?=$value['id_matkul'] ?>">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   Apakah anda yakin ingin menghapus <b><?= $value['mata_kuliah']?>.?</b>?
