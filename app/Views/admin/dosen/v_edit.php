    ...
    <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>NIDN</label>
                        <input name="nidn" class="form-control"  value="<?=$dosen['nidn']?>">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="password" class="form-control" value="<?=$dosen['password']?>" >
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                            <img src="<?= base_url('fotodosen/'.$dosen['foto_dosen'])?>" width="150px" id="gambar_load" alt="">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
