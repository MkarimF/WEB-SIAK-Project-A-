    ...
    <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <a href="<?= base_url('dosen/add')?>" class="btn btn-box-tool"  class="btn btn-default"><i class="fa fa-plus"></i>Add</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
                ...
                <table class="table table-bordered table-responsive" id="example1">
                    ...
                    foreach ($dosen as $key => $value) {?>
                        <tr>
                            ...
                            <td class="text-center"><img class="img-circle" src="<?= base_url('fotodosen/'.$value['foto_dosen'])?>" width="50px" height="50px"></td>
