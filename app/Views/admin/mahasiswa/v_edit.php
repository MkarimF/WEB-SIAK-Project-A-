            ...
            <div class="box-body">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="password" value="<?= $mhs['password']?>"class="form-control">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Program Studi</label>
                            <select name="id_prodi" class="form-control">
                                <option value="<?= $mhs['id_prodi']?>"><?= $mhs['jenjang']?>-<?= $mhs['proddi']?></option>
                                <?php foreach($prodi as $key => $value){ ?>
                                    <option value="<?=$value['id_prodi']?>"><?= $mhs['jenjang']?>-<?=$value['proddi']?></option>
                                <?php } ?>
                            </select>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                            <img src="<?= base_url('fotomhs/'.$mhs['foto_mhs'])?>" width="150px" id="gambar_load" alt="">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
