...
public function __construct()
{
    ...
    public function insert()
    {
        if ($this->validate([
			...
			'foto_dosen'=>[
				'label'=>'Foto Dosen',
				'rules'=>'uploaded[foto_dosen]|max_size[foto_dosen,1024]|mime_in[foto_dosen,image/png,image/jpg,image/jpeg,image/gif,image/ico]',
				'errors'=>[
					'uploaded'=> '{field} Wajib Diisi !!!',
					'max_size'=> '{field} Maximal 1MB !!!',
					'mime_in'=> '{field} Format Wajib PNG, JPG, JPEG, GIF, ICO !!!',
				]
			],
		])) {
		...
		//mempindahkan file foto dari form input ke folder foto di directory
    ...
    public function update($id_dosen)
	{
		if ($this->validate([
			...
			'foto_dosen'=>[
				'label'=>'Foto Dosen',
				'rules'=>'max_size[foto_dosen,1024]|mime_in[foto_dosen,image/png,image/jpg,image/jpeg,image/gif,image/ico]',
				'errors'=>[
					'max_size'=> '{field} Maximal 1MB !!!',
					'mime_in'=> '{field} Format Wajib PNG, JPG, JPEG, GIF, ICO !!!',
				]
