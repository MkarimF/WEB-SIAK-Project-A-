...
class Mahasiswa extends BaseController
{
        ...
        public function insert()
    {
        if ($this->validate([
			...
			'foto_mhs'=>[
				...
				'rules'=>'uploaded[foto_mhs]|max_size[foto_mhs,1024]|mime_in[foto_mhs,image/png,image/jpg,image/jpeg,image/gif,image/ico]',
				'errors'=>[
        ...
        public function update($id_mhs)
    {
        if ($this->validate([
			...
			'foto_mhs'=>[
				'label'=>'Foto Mahasiswa',
				'rules'=>'max_size[foto_mhs,1024]|mime_in[foto_mhs,image/png,image/jpg,image/jpeg,image/gif,image/ico]',
				'errors'=>[
					'max_size'=> '{field} Maximal 1MB !!!',
					'mime_in'=> '{field} Format Wajib PNG, JPG, JPEG, GIF, ICO !!!',
				]
